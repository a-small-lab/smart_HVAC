...
# for every time in ustacked_fan, find closest time in unit_supply_air after said time
time_difference = function(time, times){
  ...
  unit_supply_air[unit_supply_air$time == rel_time,"AHU2W_fan_status"] = unstacked_fan[unstacked_fan$time==time, "AHU2W_fan_status"]
...
temp = as.data.frame(times - times[200])
